...
-(VkResult) initialise    
{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "initialise() : createTexture() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		fprintf(gpFile, "initialise() : createTexture() succeeded\n");
		fflush(gpFile);
	}
	...
	if (vkresult != VK_SUCCESS) {
		fprintf(gpFile, "initialise() : createDiscriptorSetLayout() failed (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
...
-(VkResult) createTexture
{
   ...
   [self makeChangeImage];
    ...
    // step 5: copy staging buffer -> image
    {
        ...
        if (vkresult != VK_SUCCESS)
        {
            fprintf(gpFile, "createTexture() : vkBeginCommandBuffer() function failed for buffer to image. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            fprintf(gpFile, "createTexture() : vkBeginCommandBuffer() succeeded for buffer to image.\n");
            fflush(gpFile);
        }
        ...
        {
            fprintf(gpFile, "createTexture() : vkEndCommandBuffer() succeeded for buffer to image.\n");
            fflush(gpFile);
        }
        ...
        {
            fprintf(gpFile, "createTexture() : vkQueueSubmit() succeeded for buffer to image.\n");
            fflush(gpFile);
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            fprintf(gpFile, "createTexture() : vkQueueWaitIdle() function failed for buffer to image. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            fprintf(gpFile, "createTexture() : vkQueueWaitIdle() succeeded for buffer to image.\n");
            fflush(gpFile);
        }
    ...
    // step 6: transition TRANSFER_DST_OPTIMAL -> SHADER_READ_ONLY_OPTIMAL
    {
        ...
        if (vkresult != VK_SUCCESS)
        {
            fprintf(gpFile, "createTexture() : vkAllocateCommandBuffers() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            fprintf(gpFile, "createTexture() : vkAllocateCommandBuffers() succeeded for step 6.\n");
            fflush(gpFile);
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            fprintf(gpFile, "createTexture() : vkBeginCommandBuffer() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            fprintf(gpFile, "createTexture() : vkBeginCommandBuffer() succeeded for step 6.\n");
            fflush(gpFile);
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            fprintf(gpFile, "createTexture() : vkEndCommandBuffer() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            fprintf(gpFile, "createTexture() : vkEndCommandBuffer() succeeded for step 6.\n");
            fflush(gpFile);
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            fprintf(gpFile, "createTexture() : vkQueueSubmit() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            fprintf(gpFile, "createTexture() : vkQueueSubmit() succeeded for step 6.\n");
            fflush(gpFile);
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            fprintf(gpFile, "createTexture() : vkQueueWaitIdle() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            fprintf(gpFile, "createTexture() : vkQueueWaitIdle() succeeded for step 6.\n");
            fflush(gpFile);
        }
...
-(VkResult) createUniformBuffer
{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createUniformBuffer() : vkCreateBuffer() function failed for uniformData_Straight Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createUniformBuffer() : vkCreateBuffer() succeeded for uniformData_Straight\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createUniformBuffer() : vkAllocateMemory() function failed for uniformData_Straight Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createUniformBuffer() : vkAllocateMemory() succeeded for uniformData_Straight\n");
	}

	vkresult = vkBindBufferMemory(vkDevice, uniformData_Staight.vkBuffer, uniformData_Staight.vkDeviceMemory, 0);
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createUniformBuffer() : vkBindBufferMemory() function failed for uniformData_Straight Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createUniformBuffer() : vkBindBufferMemory() succeeded for uniformData_Straight\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createUniformBuffer() : vkCreateBuffer() function failedf for uniformData_Oblique Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createUniformBuffer() : vkCreateBuffer() succeeded for uniformData_Oblique\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createUniformBuffer() : vkAllocateMemory() function failed for uniformData_Oblique Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createUniformBuffer() : vkAllocateMemory() succeeded for uniformData_Oblique\n");
	}

	vkresult = vkBindBufferMemory(vkDevice, uniformData_Oblique.vkBuffer, uniformData_Oblique.vkDeviceMemory, 0);
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createUniformBuffer() : vkBindBufferMemory() function failed for uniformData_Oblique Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createUniformBuffer() : vkBindBufferMemory() succeeded for uniformData_Oblique \n");
	}
...
-(VkResult) updateUniformbuffer
{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "updateUniformbuffer() : vkMapMemory() function failedf for uniform_Straight Error Code: (%d)\n", vkresult);
		return vkresult;
	}
...
-(VkResult) createDescriptorSet
{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createDescriptorSet() : vkCreateDescriptorPool() failed for vkDescriptorSet_Staight Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createDescriptorSet() : vkCreateDescriptorPool() succeeded for vkDescriptorSet_Staight\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createDescriptorSet() : vkCreateDescriptorPool() failedF for vkDescriptorSet_Oblique Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createDescriptorSet() : vkCreateDescriptorPool() succeeded for vkDescriptorSet_Oblique\n");
	}
