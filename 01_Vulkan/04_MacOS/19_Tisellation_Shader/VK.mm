    ...
    switch(key)
    {
        ...
        case NSUpArrowFunctionKey:
			...
			[[self window] setTitle:[NSString stringWithFormat:
				@"PRSWindow [numberOfLineSegment = %u]",
				uiNumberOfLinesSegment]];
			break;
...
-(VkResult) updateUniformbuffer
{
	...
	modelMatrix = glm::translate(glm::mat4(1.0), glm::vec3(0.0f, 0.0f, -4.0f));
...
-(VkResult) createShaders
{
	...
	if (fp == NULL)
	{
		fprintf(gpFile, "createShaders() : createShader failed to open tessellation control shader file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to open tessellation control shader file\n");
	}
	...
	if (size == 0)
	{
		fprintf(gpFile, "createShaders() : tessellation control shader file size is 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if (retVal != 1)
	{
		fprintf(gpFile, "createShaders() : failed to read tessellation control shader file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : succeeded to read tessellation control shader file\n");
	}
	...
	vkresult = vkCreateShaderModule(
					...
					NULL,
					&vkShaderModule_tessellation_Control_shader);

	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() failed for tessellation control shader (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
	...
	fprintf(gpFile, "Tessellation Control Shader Module successfully created\n");
	...
	if (fp == NULL)
	{
		fprintf(gpFile, "createShaders() : createShader failed to open tessellation evaluation shader file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to open tessellation evaluation shader file\n");
	}
	...
	if (size == 0)
	{
		fprintf(gpFile, "createShaders() : tessellation evaluation shader file size is 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if (retVal != 1)
	{
		fprintf(gpFile, "createShaders() : failed to read tessellation evaluation shader file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : succeeded to read tessellation evaluation shader file\n");
	}
	...
	vkresult = vkCreateShaderModule(
					...
					&vkShaderModuleCreateInfo,
					NULL,
					&vkShaderModule_tessellation_Evaluation_shader);

	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() failed for tessellation evaluation shader (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
	...
	fprintf(gpFile, "Tessellation Evaluation Shader Module successfully created\n");
