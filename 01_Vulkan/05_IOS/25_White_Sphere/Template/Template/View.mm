...
-(VkResult) createIndexBuffer
{
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createIndexBuffer() : vkCreateBuffer() function failed for position index buffer Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createIndexBuffer() : vkCreateBuffer() succeeded position index buffer \n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createIndexBuffer() : vkAllocateMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createIndexBuffer() : vkAllocateMemory() succeeded for position index buffer \n");
    }

    vkresult = vkBindBufferMemory(vkDevice, vertexData_Index.vkBuffer, vertexData_Index.vkDeviceMemory, 0);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createIndexBuffer() : vkBindBufferMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createIndexBuffer() : vkBindBufferMemory() succeeded for position index buffer\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createIndexBuffer() : vkMapMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createIndexBuffer() : vkMapMemory() succeeded for position index buffer\n");
    }
