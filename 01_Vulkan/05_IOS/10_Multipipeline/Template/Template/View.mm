...
-(VkResult) initialise
{
   ...
   vkresult = [self createVulkanInstance];
    ...
    vkresult = [self createPipeline:&vkPipeline_Triangle
                    primitiveTopology:VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST];

    if (vkresult != VK_SUCCESS)
    {
        printf( "initialise() : createPipeline() function failed for triangle (%d)\n", vkresult);
        return(vkresult);
    }
    else
    {
        printf( "initialise() : createPipeline() succeeded for triangle\n");
    }

    // Create Pipeline for Rectangle
    vkresult = [self createPipeline:&vkPipeline_Rectangle
                    primitiveTopology:VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST];

    if (vkresult != VK_SUCCESS)
    {
        printf( "initialise() : createPipeline() function failed for rectangle (%d)\n", vkresult);
        return(vkresult);
    }
    else
    {
        printf( "initialise() : createPipeline() succeeded for rectangle\n");
    }
...
-(VkResult) resize : (int)width : (int)heigth
{
    ...
    if (vkPipeline_Rectangle)
    {
        ...
        printf( "\n resize() : Free vkPipeline_Rectangle: Pipeline freed successfully for Rectangle\n");
    }
    ...
    if (vkPipeline_Triangle)
    {
        ...
        printf( "\n resize() : Free vkPipeline_Triangle: Pipeline freed successfully for triangle\n");
    }
...
-(void)uninitialise
{
    ...
    if (vkDevice)
    {
        ...
        if (vkPipeline_Triangle)
        {
            vkDestroyPipeline(vkDevice, vkPipeline_Triangle, NULL);
            vkPipeline_Triangle = VK_NULL_HANDLE;
            printf( "\nFree vkPipeline_Triangle: Pipeline freed successfully for triangle\n");
        }
        ...
        if (vkPipeline_Rectangle)
        {
            vkDestroyPipeline(vkDevice, vkPipeline_Rectangle, NULL);
            vkPipeline_Rectangle = VK_NULL_HANDLE;
            printf( "\nFree vkPipeline_Rectangle: Pipeline freed successfully for Rectangle\n");
        }
...
-(VkResult) createVertexBuffer
{
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkCreateBuffer() function failed  for triangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkCreateBuffer() succeeded  for triangle \n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkAllocateMemory() function failed  for triangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkAllocateMemory() succeeded  for triangle\n");
    }

    vkresult = vkBindBufferMemory(vkDevice, vertexData_Position_Triangle.vkBuffer, vertexData_Position_Triangle.vkDeviceMemory, 0);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkBindBufferMemory() function failed  for triangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkBindBufferMemory() succeeded  for triangle\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkMapMemory() function failed  for triangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkMapMemory() succeeded for triangle \n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkCreateBuffer() function failed for rectangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkCreateBuffer() succeeded for rectangle \n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkAllocateMemory() function failed for rectangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkAllocateMemory() succeeded for rectangle\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkBindBufferMemory() function failed for rectangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkBindBufferMemory() succeeded for rectangle\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkMapMemory() function failed for rectangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkMapMemory() succeeded for rectangle\n");
    }
...
-(VkResult) createUniformBuffer
{
    ...
    VkBool32 foundMatchingMemoryType_Uniform_Rect = VK_FALSE;
    ...
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_Uniform_Rect = VK_TRUE;
                break;
            }
        }
    ...
    if (foundMatchingMemoryType_Uniform_Rect == VK_FALSE)
    {
        vkresult = VK_ERROR_OUT_OF_HOST_MEMORY;
        printf( "createUniformBuffer() : Failed to find suitable memory type for uniform buffer\n");
        return vkresult; // Return hardcoded error code
...
-(VkResult) updateUniformbuffer
{
    ...
    myUniformData.modelMatrix = glm::translate(glm::mat4(1.0), glm::vec3(-1.5f, 0.0f, -6.0f));
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "updateUniformbuffer() : vkMapMemory() function failed for triangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "updateUniformbuffer() : vkMapMemory() function failed for Rectangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
...
-(VkResult) createDescriptorSet
{
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() failed for Triangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() succeeded for Triangle\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() failed for Rectangle Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() succeeded for reactngle\n");
    }
...
-(VkResult)createPipeline:(VkPipeline *)pPipeline
