...
-(VkResult) createShaders
{
    ...
    if (fp == NULL)
    {
        printf( "createShaders() : createShader failed to open tessellation control shader file\n");
        vkresult = VK_ERROR_INITIALIZATION_FAILED;
        return vkresult;
    }
    else
    {
        printf( "createShaders() : createShader succeeded to open tessellation control shader file\n");
    }
    ...
    if (size == 0)
    {
        printf( "createShaders() : tessellation control shader file size is 0\n");
        vkresult = VK_ERROR_INITIALIZATION_FAILED;
        return vkresult;
    }
    ...
    if (retVal != 1)
    {
        printf( "createShaders() : failed to read tessellation control shader file\n");
        free(shaderData);
        shaderData = NULL;
        vkresult = VK_ERROR_INITIALIZATION_FAILED;
        return vkresult;
    ...
    {
        printf( "createShaders() : succeeded to read tessellation control shader file\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createShaders() : vkCreateShaderModule() failed for tessellation control shader (%d)\n", vkresult);
        free(shaderData);
        shaderData = NULL;
        return vkresult;
    }
    ...
    {
        printf( "createShaders() : vkCreateShaderModule() succeeded for tessellation control shader\n");
    }

    free(shaderData);
    shaderData = NULL;

    printf( "Tessellation Control Shader Module successfully created\n");
    ...
    if (fp == NULL)
    {
        printf( "createShaders() : createShader failed to open tessellation evaluation shader file\n");
        vkresult = VK_ERROR_INITIALIZATION_FAILED;
        return vkresult;
    }
    else
    {
        printf( "createShaders() : createShader succeeded to open tessellation evaluation shader file\n");
    }
    ...
    if (size == 0)
    {
        printf( "createShaders() : tessellation evaluation shader file size is 0\n");
        vkresult = VK_ERROR_INITIALIZATION_FAILED;
        return vkresult;
    }
    ...
    if (retVal != 1)
    {
        printf( "createShaders() : failed to read tessellation evaluation shader file\n");
        free(shaderData);
        shaderData = NULL;
        vkresult = VK_ERROR_INITIALIZATION_FAILED;
        return vkresult;
    ...
    {
        printf( "createShaders() : succeeded to read tessellation evaluation shader file\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createShaders() : vkCreateShaderModule() failed for tessellation evaluation shader (%d)\n", vkresult);
        free(shaderData);
        shaderData = NULL;
        return vkresult;
    }
    ...
    {
        printf( "createShaders() : vkCreateShaderModule() succeeded for tessellation evaluation shader\n");
    }

    free(shaderData);
    shaderData = NULL;

    printf( "Tessellation Evaluation Shader Module successfully created\n");
