...
UniformData uniformData_Staight;
...
uint8_t checkImage[CHECK_IMAGE_WIDTH][CHECK_IMAGE_HEIGHT][4];
...
-(VkResult) initialise
{
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialise() : createTexture() function failed (%d)\n", vkresult);
        return(vkresult);
    }
    else
    {
        printf( "initialise() : createTexture() succeeded\n");
    ...
    vkClearColorValue.float32[0] = 0.75f;
    vkClearColorValue.float32[1] = 0.75f;
    vkClearColorValue.float32[2] = 0.75f;
...
-(void)uninitialise
{
    ...
    if (vkDevice)
    {
        ...
        if (uniformData_Oblique.vkDeviceMemory)
        {
            ...
            printf( "\nFreed uniformData_Oblique.vkDeviceMemory \n");
        }
        ...
        if (uniformData_Oblique.vkBuffer)
        {
            ...
            printf( "\nFreed uniformData_Oblique.vkBuffer \n");
        }

        // Destroy uniform buffer

        if (uniformData_Staight.vkDeviceMemory)
        {
            vkFreeMemory(vkDevice, uniformData_Staight.vkDeviceMemory, NULL);
            uniformData_Staight.vkDeviceMemory = VK_NULL_HANDLE;
            printf( "\nFreed uniformData_Staight.vkDeviceMemory \n");
        }


        if (uniformData_Staight.vkBuffer)
        {
            vkDestroyBuffer(vkDevice, uniformData_Staight.vkBuffer, NULL);
            uniformData_Staight.vkBuffer = VK_NULL_HANDLE;
            printf( "\nFreed uniformData_Staight.vkBuffer \n");
        }
...
-(VkResult) createTexture
{
   ...
   [self makeChangeImage];

    uint8_t* image_Data = NULL;

    image_Data = (uint8_t*)checkImage;

    int texture_width = CHECK_IMAGE_WIDTH;
    int texture_Height = CHECK_IMAGE_HEIGHT;
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkCreateBuffer() function failed. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkCreateBuffer() succeeded.\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkAllocateMemory() function failed. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkAllocateMemory() succeeded.\n");
    }

    vkresult = vkBindBufferMemory(vkDevice, vkBuffer_StaggingBuffer, VkDeviceMemory_StaggingBuffer, 0);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkBindBufferMemory() function failed. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkBindBufferMemory() succeeded.\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkMapMemory() function failed for staging buffer. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkMapMemory() succeeded for staging buffer.\n");
    }
    ...
    image_Data = NULL; // make image data NULL to avoid dangling pointer
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkCreateImage() function failed. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkCreateImage() succeeded.\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkAllocateMemory() function failed for image. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkAllocateMemory() succeeded for image.\n");
    }

    vkresult = vkBindImageMemory(vkDevice, vkImage_Texture, vkDeviceMemory_Texture, 0);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkBindImageMemory() function failed for image. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkBindImageMemory() succeeded for image.\n");
    }
    ...
    // step 4: transition UNDEFINED -> TRANSFER_DST_OPTIMAL
    {
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkAllocateCommandBuffers() function failed. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkAllocateCommandBuffers() succeeded.\n");
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkBeginCommandBuffer() function failed. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkBeginCommandBuffer() succeeded.\n");
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkEndCommandBuffer() function failed. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkEndCommandBuffer() succeeded.\n");
        }
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkQueueSubmit() function failed. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkQueueSubmit() succeeded.\n");
        }

        vkresult = vkQueueWaitIdle(vkQueue);
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkQueueWaitIdle() function failed. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkQueueWaitIdle() succeeded.\n");
    ...
    // step 5: copy staging buffer -> image
    {
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkAllocateCommandBuffers() function failed for buffer to image. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkAllocateCommandBuffers() succeeded for buffer to image.\n");
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkBeginCommandBuffer() function failed for buffer to image. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkBeginCommandBuffer() succeeded for buffer to image.\n");
        ...
        vkCmdCopyBufferToImage(VkCommandBuffer_Buffer_To_Image_Copy,
            vkBuffer_StaggingBuffer, vkImage_Texture,
            VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &vkBufferImageCopy);

        vkresult = vkEndCommandBuffer(VkCommandBuffer_Buffer_To_Image_Copy);
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkEndCommandBuffer() function failed for buffer to image. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkEndCommandBuffer() succeeded for buffer to image.\n");
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkQueueSubmit() function failed for buffer to image. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkQueueSubmit() succeeded for buffer to image.\n");
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkQueueWaitIdle() function failed for buffer to image. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkQueueWaitIdle() succeeded for buffer to image.\n");
    ...
    // step 6: transition TRANSFER_DST_OPTIMAL -> SHADER_READ_ONLY_OPTIMAL
    {
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkAllocateCommandBuffers() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkAllocateCommandBuffers() succeeded for step 6.\n");
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkBeginCommandBuffer() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkBeginCommandBuffer() succeeded for step 6.\n");
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkEndCommandBuffer() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkEndCommandBuffer() succeeded for step 6.\n");
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkQueueSubmit() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkQueueSubmit() succeeded for step 6.\n");
        ...
        if (vkresult != VK_SUCCESS)
        {
            printf( "createTexture() : vkQueueWaitIdle() function failed for step 6. Error Code: (%d)\n", vkresult);
            return vkresult;
        }
        else
        {
            printf( "createTexture() : vkQueueWaitIdle() succeeded for step 6.\n");
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkCreateImageView() function failed. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkCreateImageView() succeeded.\n");
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createTexture() : vkCreateSampler() failed. Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createTexture() : vkCreateSampler() succeeded.\n");
...
-(VkResult) createUniformBuffer
{
    ...
    // for staright
    memset((void*)&uniformData_Staight, 0, sizeof(UniformData));

    vkresult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &uniformData_Staight.vkBuffer);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createUniformBuffer() : vkCreateBuffer() function failed for uniformData_Straight Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createUniformBuffer() : vkCreateBuffer() succeeded for uniformData_Straight\n");
    }

    VkMemoryRequirements vkMemoryRequirements;
    memset((void*)&vkMemoryRequirements, 0, sizeof(VkMemoryRequirements));

    vkGetBufferMemoryRequirements(vkDevice, uniformData_Staight.vkBuffer, &vkMemoryRequirements);
    ...
    vkresult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &uniformData_Staight.vkDeviceMemory);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createUniformBuffer() : vkAllocateMemory() function failed for uniformData_Straight Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createUniformBuffer() : vkAllocateMemory() succeeded for uniformData_Straight\n");
    }

    vkresult = vkBindBufferMemory(vkDevice, uniformData_Staight.vkBuffer, uniformData_Staight.vkDeviceMemory, 0);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createUniformBuffer() : vkBindBufferMemory() function failed for uniformData_Straight Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createUniformBuffer() : vkBindBufferMemory() succeeded for uniformData_Straight\n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createUniformBuffer() : vkCreateBuffer() function failedf for uniformData_Oblique Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createUniformBuffer() : vkCreateBuffer() succeeded for uniformData_Oblique\n");
    }
    ...
    VkBool32 foundMatchingMemoryType_Uniform_Checkkar = VK_FALSE;
    ...
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_Uniform_Checkkar = VK_TRUE;
                break;
            }
        }
    ...
    if (foundMatchingMemoryType_Uniform_Checkkar == VK_FALSE)
    {
        vkresult = VK_ERROR_OUT_OF_HOST_MEMORY;
        printf( "createUniformBuffer() : Failed to find suitable memory type for uniform buffer\n");
        return vkresult; // Return hardcoded error code
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createUniformBuffer() : vkAllocateMemory() function failed for uniformData_Oblique Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createUniformBuffer() : vkAllocateMemory() succeeded for uniformData_Oblique\n");
    }

    vkresult = vkBindBufferMemory(vkDevice, uniformData_Oblique.vkBuffer, uniformData_Oblique.vkDeviceMemory, 0);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createUniformBuffer() : vkBindBufferMemory() function failed for uniformData_Oblique Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createUniformBuffer() : vkBindBufferMemory() succeeded for uniformData_Oblique \n");
    }
...
-(VkResult) updateUniformbuffer
{
    ...
    translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(-1.0f, 0.0f, -4.0f));
    ...
    vkresult = vkMapMemory(vkDevice, uniformData_Staight.vkDeviceMemory, 0, sizeof(MyUniformData), 0, &data);
    if (vkresult != VK_SUCCESS)
    {
        printf( "updateUniformbuffer() : vkMapMemory() function failedf for uniform_Straight Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    ...
    vkUnmapMemory(vkDevice, uniformData_Staight.vkDeviceMemory);
    ...
    translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(1.0f, 0.0f, -4.5f));

    glm::mat4 rotationMatrix = glm::mat4(1.0);

    rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(30.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    vkresult = vkMapMemory(vkDevice, uniformData_Oblique.vkDeviceMemory, 0, sizeof(MyUniformData), 0, &data);
    if (vkresult != VK_SUCCESS)
    {
...
-(VkResult) createDescriptorSet
{
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() failed for vkDescriptorSet_Staight Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() succeeded for vkDescriptorSet_Staight\n");
    }
    ...
    // for mvp unform
    vkdescriptorBufferInfo.buffer = uniformData_Staight.vkBuffer;
    ...
    printf( "\nvkUpdateDescriptorSets() succeeded for vkDescriptorSet_Staight\n");
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() failedF for vkDescriptorSet_Oblique Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createDescriptorSet() : vkCreateDescriptorPool() succeeded for vkDescriptorSet_Oblique\n");
    }
    ...
    printf( "\nvkUpdateDescriptorSets() succeeded for vkDescriptorSet_Oblique\n");
...
-(VkResult) buildCommandBuffers
{
    ...
    for (uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdBindDescriptorSets(
            ...
            &vkDescriptorSet_Straight, // pointer to array of VkDescriptorSet
        ...
        vkCmdBindDescriptorSets(
            ...
            0,              // firstSet
            1,              // descriptorSetCount
            &vkDescriptorSet_Oblique, // pointer to array of VkDescriptorSet
            0,              // dynamicOffsetCount
            NULL            // pDynamicOffsets
        );
