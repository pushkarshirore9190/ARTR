...
-(VkResult) updateUniformbuffer
{
    ...
    myUniformData.lightPosition1[0] = 100.0f;
    myUniformData.lightPosition1[1] = 100.0f;
    myUniformData.lightPosition1[2] = 100.0f;
    myUniformData.lightPosition1[3] = 1.0f;

    // Light 2
    myUniformData.lightAmbient2[0] = 0.1f;   // Low red ambient
    myUniformData.lightAmbient2[1] = 0.0f;
    myUniformData.lightAmbient2[2] = 0.0f;
    myUniformData.lightAmbient2[3] = 1.0f;

    myUniformData.lightDiffuse2[0] = 1.0f;   // Strong red diffuse
    myUniformData.lightDiffuse2[1] = 0.0f;
    myUniformData.lightDiffuse2[2] = 0.0f;
    myUniformData.lightDiffuse2[3] = 1.0f;

    myUniformData.lightSpecular2[0] = 1.0f;  // Red specular highlight
    myUniformData.lightSpecular2[1] = 0.0f;
    myUniformData.lightSpecular2[2] = 0.0f;
    myUniformData.lightSpecular2[3] = 1.0f;

    myUniformData.lightPosition2[0] = -100.0f;
    myUniformData.lightPosition2[1] = 100.0f;
    myUniformData.lightPosition2[2] = 100.0f;
