...
-(VkResult) createVulkanInstance
{
	...
	if (vkresult != VK_SUCCESS)
	{
		printf( "createVulkanInstance() : fillExtensionNames function failed\n");
		return(vkresult);
	}
	else
	{
	...
	if (bValidation == YES)
	{
		...
		if (vkresult != VK_SUCCESS)
		{
			printf( "createVulkanInstance() : fillValidationLayerNames() function failed (VkResult: %d)\n", vkresult);
			return vkresult;
		}
		else
		{
	...
	{
		printf( "createVulkanInstance() : vkCreateInstance() function failed due to incompatible driver (%d)\n", vkresult);
		return vkresult;
	}
	else if (vkresult == VK_ERROR_EXTENSION_NOT_PRESENT)
	{
		printf( "createVulkanInstance() : vkCreateInstance() function failed due to required extension not present (%d)\n", vkresult);
		return vkresult;
	}
	else if (vkresult != VK_SUCCESS)
	{
		printf( "createVulkanInstance() : vkCreateInstance() function failed due to unknown reason (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		printf( "createVulkanInstance() : vkCreateInstance() function succeeded\n");
	}
	...
	if (bValidation == YES)
	{
		...
		if (vkresult != VK_SUCCESS)
		{
			printf( "createVulkanInstance() : createValidationCallbackfuntion() function failed (VkResult: %d)\n", vkresult);
			return vkresult;
		}
		else
		{
			printf( "createVulkanInstance() : createValidationCallbackfuntion() succeeded\n");
		}
	}
...
-(VkResult) fillExtensionNames
{
	...
	if (vkresult != VK_SUCCESS)
	{
		printf( "fillExtensionNames() : vkEnumerateInstanceExtensionProperties function 1st call failed with error code %d\n", vkresult);
		return vkresult;
	}
	else
	{
		printf( "fillExtensionNames() : vkEnumerateInstanceExtensionProperties() 1st call succeeded. Extension count: %d\n", instanceExtensionCount);
	}
	...
	{
		printf( "fillExtensionNames() : Memory allocation failed for VkExtensionProperties_array\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		printf( "fillExtensionNames() : vkEnumerateInstanceExtensionProperties function 2nd call failed with error code %d\n", vkresult);
		free(vkExtensionProperties_array);
		return vkresult;
	}
	else
	{
		printf( "fillExtensionNames() : vkEnumerateInstanceExtensionProperties() 2nd call succeeded\n");
	}
	...
	{
		printf( "fillExtensionNames() : Memory allocation failed for InstanceExtensionNames_array\n");
		free(vkExtensionProperties_array);
		return VK_ERROR_OUT_OF_HOST_MEMORY;
	}
	...
	for (uint32_t i = 0; i < instanceExtensionCount; i++)
	{
		...
		printf( "fillExtensionNames() : Vulkan Extension name = %s\n", InstanceExtensionNames_array[i]);
	}
	...
	if (vulkunSurfaceExtensionFound == VK_FALSE)
	{
		...
		printf( "fillExtensionNames() : VK_KHR_SURFACE_EXTENSION_NAME not found\n");
		return vkresult;
	}
	else
	{
		printf( "fillExtensionNames() : VK_KHR_SURFACE_EXTENSION_NAME found\n");
	}

	if (macOSSurfaceExtensionFound == VK_FALSE)
	{
		vkresult = VK_ERROR_INITIALIZATION_FAILED; // return hardcoded failure
		printf( "fillExtensionNames() : VK_MVK_MACOS_SURFACE_EXTENSION_NAME not found\n");
		return vkresult;
	}
	else
	{
		printf( "fillExtensionNames() : VK_MVK_MACOS_SURFACE_EXTENSION_NAME found\n");
	}

	if (vulkanPortabilityEnumerationExtensionFound == VK_FALSE)
	{
		vkresult = VK_ERROR_INITIALIZATION_FAILED; // return hardcoded failure
		printf( "fillExtensionNames() : VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME not found\n");
		return vkresult;
	}
	else
	{
		printf( "fillExtensionNames() : VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME found\n");
	}
	...
	if (vulkunSurfaceExtensionFound == VK_FALSE)
	{
		...
		{
			vkresult = VK_ERROR_INITIALIZATION_FAILED; // return hardcoded failure
			printf( "fillExtensionNames() : validation is on but required  VK_EXT_DEBUG_REPORT_EXTENSION_NAME not found\n");
			return vkresult;
		}
		else
		{
			printf( "fillExtensionNames() :  validation is off and VK_EXT_DEBUG_REPORT_EXTENSION_NAME is not suppoerted found\n");
		}
	}
	else
	{
		if (bValidation == TRUE)
		{
			printf( "fillExtensionNames() : validation is on and  VK_EXT_DEBUG_REPORT_EXTENSION_NAME is also found\n");
		}
		else
		{
			printf( "fillExtensionNames() : validation is off and VK_EXT_DEBUG_REPORT_EXTENSION_NAME is suppoerted found\n");
		}
	...
	{
		printf( "fillExtensionNames() : enabled Vulkan extension name = %s\n", enabledInstanceExtensionNames_array[i]);
	}
...
-(VkResult) fillValidationLayerNames
{
	...
	if (vkresult != VK_SUCCESS)
	{
		printf( "fillValidationLayerNames() : vkEnumerateInstanceLayerProperties function 1st call failed with error code %d\n", vkresult);
		return vkresult;
	}
	else
	{
		printf( "fillValidationLayerNames() : vkEnumerateInstanceLayerProperties() 1st call succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		printf( "fillValidationLayerNames() : vkEnumerateInstanceLayerProperties function 2nd call failed with error code %d\n", vkresult);
		return vkresult;
	}
	else
	{
		printf( "fillValidationLayerNames() : vkEnumerateInstanceLayerProperties() 2nd call succeeded\n");
	}
	...
	{
		printf( "fillValidationLayerNames() : enabled Vulkan layer name = %s\n", enabledValidationLayerNames_Array[i]);
	}
...
-(VkResult) createValidationCallbackfuntion
{
	...
	{
		vkresult = VK_ERROR_INITIALIZATION_FAILED; // return hardcoded failure
		printf( "createValidationCallbackfuntion() : vkGetInstanceProcAddr() failed to get function pointer failed with error code %d \n vkCreateDebugReportCallbackEXT\n", vkresult);
		return vkresult;
	}
	else
	{
		printf( "createValidationCallbackfuntion() : vkGetInstanceProcAddr() succeded to get function pointer for \n vkCreateDebugReportCallbackEXT\n");
	}
	...
	{
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		printf( "createValidationCallbackFunction() : vkGetInstanceProcAddr() failed to get function pointer for with error code %d\n vkDestroyDebugReportCallbackEXT\n", vkresult);
		return vkresult;
	}
	else
	{
		printf( "createValidationCallbackFunction() : vkGetInstanceProcAddr() succeeded in getting function pointer for vkDestroyDebugReportCallbackEXT\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		printf( "createValidationCallbackfuntion() : vkCreateDebugReportCallbackEXT_fnptr function failed with error code %d\n", vkresult);
		return vkresult;
	}
	else
	{
		printf( "createValidationCallbackfuntion() : vkCreateDebugReportCallbackEXT_fnptr() succeeded\n");
	}


	printf( "createValidationCallbackfuntion() : ******************************************* EXITING FROM THIS FUNCTIION*********************************\n");
	return vkresult;
...
-(VkResult) getSupportedSurface
{
	...
	if(vkresult != VK_SUCCESS)
	{
		printf( "getSupportedSurface() : vkCreateMacOSSurfaceMVK Failed\n");
		return vkresult;
	}
	else
	{
		printf( "getSupportedSurface() : vkCreateMacOSSurfaceMVK succeded \n");
	}
...
{
	//code
	printf( "PRS_Validation : debugReportCallback() :  %s (%d) = %s\n", pLayerPrefix, messageCode, pMessage);
