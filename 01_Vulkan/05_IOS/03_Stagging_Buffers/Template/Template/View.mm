...
-(VkResult)createVertexBuffer
{
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkAllocateCommandBuffers() function failed to make crreateCommandBuffer for ""BufferCopy"" Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkAllocateCommandBuffers() succeeded to crreateCommandBuffer for ""BufferCopy"" \n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkBeginCommandBuffer() function failed Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkBeginCommandBuffer() succeeded \n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkCmdCopyBuffer() function failed Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkCmdCopyBuffer() succeeded \n");
    }

    vkresult = vkEndCommandBuffer(vkCommandBuffer);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkEndCommandBuffer() function failed Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkEndCommandBuffer() succeeded \n");
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkQueueSubmit() function failed Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkQueueSubmit() succeeded \n");
    }

    vkresult = vkQueueWaitIdle(vkQueue);
    if (vkresult != VK_SUCCESS)
    {
        printf( "createVertexBuffer() : vkQueueWaitIdle() function failed Error Code: (%d)\n", vkresult);
        return vkresult;
    }
    else
    {
        printf( "createVertexBuffer() : vkQueueWaitIdle() succeeded \n");
    }
    ...
    if (vertexData_StaggingBuffer_Position.vkBuffer != VK_NULL_HANDLE) {
        ...
        printf( "Local staging buffer vertexData_StaggingBuffer_Position.vkBuffer destroyed\n");
    }
    ...
    if (vertexData_StaggingBuffer_Position.vkDeviceMemory != VK_NULL_HANDLE) {
        ...
        printf( "Local staging buffer vertexData_StaggingBuffer_Position.vkDeviceMemory freed\n");
    }
