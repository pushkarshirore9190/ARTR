...
-(VkResult) initialise
{
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createVulkanInstance() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : getSupportedSurface() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : getPhysicalDevice() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : printVkInfo() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createVulkanDevice() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createSwapchain() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createImagesAndImageViews() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createCommandPool() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createCommandBuffers() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createRenderPass() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createframeBuffers() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createSemaphores() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : createFences() failed\n");
        return vkresult;
    }
    ...
    if (vkresult != VK_SUCCESS)
    {
        printf( "initialize() : buildCommandBuffers() failed\n");
        return vkresult;
    }
