...
-(VkResult) updateUniformbuffer
{
    ...
    // update light angle
    if (choosenAxis == 'X' || choosenAxis == 'Y' || choosenAxis == 'Z')
    {
...
-(VkResult) createPipline
{
    ...
    vkPipelineDepthStencilStateCreateInfo.flags = 0; // reserved
