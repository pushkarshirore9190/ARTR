...
void uninitialise(void)
{
	...
	if (vkDevice)
	{
		...
		if (vkShaderModule_geometry_shader)
		{
			...
			vkShaderModule_geometry_shader = NULL;
			__android_log_print(ANDROID_LOG_INFO, "PRS:", "\nFree vkShaderModule_geometry_shader freed\n");
		}
...
VkResult createShaders(void)
{
	...
	if (asset == NULL)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders() : createShader failed to open geometry control.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders() : createShader succeeded to open geometry control.spv file\n");
	}
	...
	if (size == 0)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders() : createShader failed and give file size of geometry control shader 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if (retVal != size)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders() : createShader failed to read geometry control.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders() : createShader succeeded to read geometry control.spv file\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders() : vkCreateShaderModule() function failed. for geometry control shader Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders() : vkCreateShaderModule() succeeded for geometry control shader.\n");
	}
