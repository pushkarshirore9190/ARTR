...
VkResult initialise(void)
{
	...
	// Create Pipline for triangle
	vkresult = createPipeline(&vkPipeline_Triangle, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST);
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPipline() function failed for triangle(%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPipline() succeeded  for triangle\n");
	}
	
	// create Pipline for rectangle
	vkresult = createPipeline(&vkPipeline_Rectangle, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST);
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPipline() function failed  for rectangle (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPipline() succeeded for rectangle\n");
	}
...
VkResult resize(int width, int heigth)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "resize() : createPipline() function failed for triangle(%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "resize() : createPipline() function failed  for rectangle (%d)\n", vkresult);
		return(vkresult);
	}
...
VkResult createVertexBuffer(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkCreateBuffer() function failed  for triangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkCreateBuffer() succeeded  for triangle \n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkAllocateMemory() function failed  for triangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkAllocateMemory() succeeded  for triangle\n");
	}

	vkresult = vkBindBufferMemory(vkDevice, vertexData_Position_Triangle.vkBuffer, vertexData_Position_Triangle.vkDeviceMemory, 0);
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkBindBufferMemory() function failed  for triangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkBindBufferMemory() succeeded  for triangle\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkMapMemory() function failed  for triangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkMapMemory() succeeded for triangle \n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkCreateBuffer() function failed for rectangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkCreateBuffer() succeeded for rectangle \n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkAllocateMemory() function failed for rectangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkAllocateMemory() succeeded for rectangle\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkBindBufferMemory() function failed for rectangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkBindBufferMemory() succeeded for rectangle\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkMapMemory() function failed for rectangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer() : vkMapMemory() succeeded for rectangle\n");
	}
...
VkResult updateUniformbuffer(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "updateUniformbuffer() : vkMapMemory() function failed for triangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "updateUniformbuffer() : vkMapMemory() function failed for Rectangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
...
VkResult createDescriptorSet(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDescriptorSet() : vkCreateDescriptorPool() failed for Triangle Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDescriptorSet() : vkCreateDescriptorPool() succeeded for Triangle\n");
	}
