...
VkResult initialise(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createImagesAndImageViews_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createImagesAndImageViews_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createCommandBuffer_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createCommandBuffer_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createVertexBuffer_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createVertexBuffer_fbo() succeeded\n");
	}

	vkresult = createIndexBuffer_fbo();
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createIndexBuffer_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
		
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createIndexBuffer_fbo() succeeded\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createTexture_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
		
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createTexture_fbo() succeeded\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createUniformBuffer_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createUniformBuffer_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createShaders_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createShaders_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createDiscriptorSetLayout_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createDiscriptorSetLayout_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPiplineLayout_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPiplineLayout_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createDescriptorpool_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createDescriptorpool_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createDescriptorSet_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createDescriptorSet_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createRenderPass_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createRenderPass_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPipline_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createPipline_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createframeBuffer_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createframeBuffer_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createSemaphore_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : createSemaphore_fbo() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : buildCommandBuffer_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "initialise() : buildCommandBuffer_fbo() succeeded\n");
	}
...
VkResult resize(int width, int heigth)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize() : createDescriptorSet() function failed (%d)\n", vkresult);
		return(vkresult);
	}
...
VkResult display(void)
{
	...
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "display(): FBO initliasation yet not completed\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "display() : vkQueueSubmit failed FOR FBO with error: %d\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "display() : vkQueueSubmit failed for host with error: %d\n", vkresult);
		return(vkresult);
	}
	...
	if(vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "display() : updateUniformBuffer_fbo() failed with error: %d\n", vkresult);
		return(vkresult);
	}
...
VkResult createImagesAndImageViews(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : getSupportedDepthFormat() function failed for iteration (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : getSupportedDepthFormat() succeeded for iteration\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : vkCreateImage() function failed for iteration (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : vkCreateImage() succeeded for iteration\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : vkAllocateMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : vkAllocateMemory() succeeded.\n");
	}

	vkresult = vkBindImageMemory(vkDevice, vkImage_Depth, vkDeviceMemory_Depth, 0);
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : vkBindImageMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : vkBindImageMemory() succeeded.\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : VkCreateImageView() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews() : VkCreateImageView() succeeded.\n");
	}
...
VkResult resize_fbo(int fbo_width, int fbo_heigth)
{
	...
	if (bInitialised_fbo == false)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "resize_fbo() : Initialisation yet not completed or failed\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	// free command buffer first because it references framebuffer, pipeline, render pass, buffers, descriptor sets
	...
	// destroy depth image before freeing its memory
	...
	// destroy FBO color image before freeing its memory
	if (vkImage_fbo)
	{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize_fbo() : createImagesAndImageViews_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize_fbo() : createRenderPass_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize_fbo() : createPiplineLayout_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize_fbo() : createPipline() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize_fbo() : createframeBuffer() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize_fbo() : createCommandBuffers_fbo() function failed (%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", " resize_fbo() : buildCommandBuffers() function failed (%d)\n", vkresult);
		return(vkresult);
	}
...
VkResult createImagesAndImageViews_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkCreateImageView() function failed: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkCreateImageView() succeeded\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkAllocateMemory() function failed for image Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkAllocateMemory() succeeded for image\n");
	}

	vkresult = vkBindImageMemory(vkDevice, vkImage_fbo, vkDeviceMemory_fbo, 0);
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkBindBufferMemory() function failed for image Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkBindBufferMemory() succeeded for image\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : VkCreateImageView() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkCreateSampler() failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkCreateSampler() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkCreateImage() function failed for iteration (%d)\n", vkresult);
		return vkresult;
		
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkCreateImage() succeeded for iteration\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkAllocateMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
		
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkAllocateMemory() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkBindImageMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
		
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createImagesAndImageViews_fbo() : vkBindImageMemory() succeeded.\n");
...
VkResult createCommandBuffer_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createCommandBuffer_fbo() : vkAllocateCommandBuffers() function failed. Error Code: (%d)\n", vkresult);
	...
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createCommandBuffer_fbo() : vkAllocateCommandBuffers() succeeded.\n");
...
VkResult createVertexBuffer_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkCreateBuffer() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkCreateBuffer() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkAllocateMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkAllocateMemory() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkBindBufferMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkBindBufferMemory() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkMapMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkMapMemory() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkCreateBuffer() function failed for normal Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkCreateBuffer() succeeded for normal\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkAllocateMemory() function failed for normal Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkAllocateMemory() succeeded for normal\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkBindBufferMemory() function failed for normal Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkBindBufferMemory() succeeded for normal\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkMapMemory() function failed for normal Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkMapMemory() succeeded for normal\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkCreateBuffer() function failed for texcoord Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkCreateBuffer() succeeded for texcoord\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkAllocateMemory() function failed for texcoord Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkAllocateMemory() succeeded for texcoord\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkBindBufferMemory() function failed for texcoord Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkBindBufferMemory() succeeded for texcoord\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkMapMemory() function failed for texcoord Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createVertexBuffer_fbo() : vkMapMemory() succeeded for texcoord\n");
...
VkResult createIndexBuffer_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkCreateBuffer() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkCreateBuffer() succeeded position index buffer \n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkAllocateMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkAllocateMemory() succeeded for position index buffer \n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkBindBufferMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkBindBufferMemory() succeeded for position index buffer\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkMapMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
			
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer_fbo() : vkMapMemory() succeeded for position index buffer\n");
...
VkResult createUniformBuffer_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : vkCreateBuffer_fbo() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : vkCreateBuffer_fbo() succeeded.\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : vkAllocateMemory_fbo() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : vkAllocateMemory_fbo() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : vkBindBufferMemory_fbo() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : vkBindBufferMemory_fbo() succeeded.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : updateUniformbuffer_fbo() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createUniformBuffer_fbo() : updateUniformbuffer_fbo() succeeded.\n");
...
VkResult updateUniformBuffer_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "updateUniformbuffer_fbo() : vkMapMemory() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
...
VkResult createShaders_fbo(void)
{
	...
	if(asset == NULL)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader failed to open vertexshader.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader succeeded to open vertexshader.spv file\n");
	}
	...
	if (size == 0)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader failed and give file size of vertex shader 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if(retVal != size)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader failed to read vertexshader.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader succeeded to read vertexshader.spv file\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : vkCreateShaderModule() function failed.for vertex shader Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : vkCreateShaderModule() succeeded fro vertex shader.\n");
	}
	...
	if(asset == NULL)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader failed to open fragmentshader.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader succeeded to open fragmentshader.spv file\n");
	}
	...
	if (size == 0)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader failed and give file size of fragment shader 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if(retVal != size)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader failed to read fragmentshader.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : createShader succeeded to read fragmentshader.spv file\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : vkCreateShaderModule() function failed. for fragment shader Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createShaders_fbo() : vkCreateShaderModule() succeeded for fragment shader.\n");
	}
...
VkResult createDiscriptorSetLayout_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDiscriptorSetLayout_fbo() : vkCreateDescriptorSetLayout() failed Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDiscriptorSetLayout_fbo() : vkCreateDescriptorSetLayout() succeeded.\n");
	}
...
VkResult createPiplineLayout_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createPiplineLayout_fbo() : vkCreatePipelineLayout() failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createPiplineLayout_fbo() : vkCreatePipelineLayout() succeeded.\n");
	}
...
VkResult createDescriptorpool_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDescriptorpool_fbo() : vkCreateDescriptorPool() failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDescriptorpool_fbo() : vkCreateDescriptorPool() succeeded.\n");
	}
...
VkResult createDescriptorSet_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDescriptorSet_fbo() : vkCreateDescriptorPool() failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createDescriptorSet_fbo() : vkCreateDescriptorPool() succeeded.\n");
	}
...
VkResult createRenderPass_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createRenderPass_fbo() : vkCreateRenderPass_fbo() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createRenderPass_fbo() : vkCreateRenderPass_fbo() succeeded.\n");
	}
...
VkResult createPipline_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createPipline_fbo() : vkCreatePipelineCache() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createPipline_fbo() : vkCreatePipelineCache() succeeded.\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createPipline_fbo() : vkCreateGraphicsPipelines() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createPipline_fbo() : vkCreateGraphicsPipelines() succeeded.\n");
	}
	...
	if (vkPipelineCache != VK_NULL_HANDLE)
	{
		vkDestroyPipelineCache(vkDevice, vkPipelineCache, NULL);
		vkPipelineCache = VK_NULL_HANDLE;
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createPipline_fbo() : Free vkPipelineCache freed\n");
	}
...
VkResult createframeBuffer_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createframeBuffers_fbo() : vkCreateFramebuffer() function failed. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createframeBuffers_fbo() : vkCreateFramebuffer() succeeded.\n");
	}
...
VkResult createSemaphore_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createSemaphores_fbo() : vkCreateSemaphore() function failed for backbuffer. Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createSemaphores_fbo() : vkCreateSemaphore() succeeded for backbuffer.\n");
	}
...
VkResult buildCommandBuffer_fbo(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "buildCommandBuffers_fbo() : vkResetCommandBuffer() failed Error Code: (%d)\n", vkresult);
		return (vkresult);
	}
	else
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "buildCommandBuffers_fbo() : vkResetCommandBuffer() successed");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "buildCommandBuffers_fbo() : vkBeginCommandBuffer() failed Error Code: (%d)\n", vkresult);
		return (vkresult);
	}
	else
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "buildCommandBuffers_fbo() : vkBeginCommandBuffer() successed.\n");
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "buildCommandBuffers_fbo() : vkEndCommandBuffer() failed Error Code: (%d)\n", vkresult);
		return (vkresult);
	}
	else
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "buildCommandBuffers_fbo() : vkEndCommandBuffer() successed.\n");
