...
struct MyUniformData
{
    ...
    // Light 1
    float lightAmbient1[4];
    float lightDiffuse1[4];
    float lightSpecular1[4];
    float lightPosition1[4];

    // Light 2
    float lightAmbient2[4];
    float lightDiffuse2[4];
    float lightSpecular2[4];
    float lightPosition2[4];

    // Light 3
    float lightAmbient3[4];
    float lightDiffuse3[4];
    float lightSpecular3[4];
    float lightPosition3[4];
...
// Three Lights update values for lights
float angle1 = 0.0f; // for light 1
float angle2   = 0.0f; // for light 2
float angle3 = 0.0f; // for light 3
...
VkResult updateUniformbuffer(void)
{
	...
	myUniformData.lightAmbient1[0] = 0.1f;
	myUniformData.lightAmbient1[1] = 0.1f;
	myUniformData.lightAmbient1[2] = 0.1f;
	myUniformData.lightAmbient1[3] = 1.0f;

	myUniformData.lightDiffuse1[0] = 1.0f;
	myUniformData.lightDiffuse1[1] = 1.0f;
	myUniformData.lightDiffuse1[2] = 1.0f;
	myUniformData.lightDiffuse1[3] = 1.0f;

	myUniformData.lightSpecular1[0] = 1.0f;
	myUniformData.lightSpecular1[1] = 1.0f;
	myUniformData.lightSpecular1[2] = 1.0f;
	myUniformData.lightSpecular1[3] = 1.0f;

	myUniformData.lightPosition1[0] = 100.0f * cos(angle1);
	myUniformData.lightPosition1[1] = 0.0f;
	myUniformData.lightPosition1[2] = 100.0f * sin(angle1);
	myUniformData.lightPosition1[3] = 1.0f;

	// Light 2

	myUniformData.lightAmbient2[0] = 0.1f;
	myUniformData.lightAmbient2[1] = 0.0f;
	myUniformData.lightAmbient2[2] = 0.0f;
	myUniformData.lightAmbient2[3] = 1.0f;

	myUniformData.lightDiffuse2[0] = 1.0f;
	myUniformData.lightDiffuse2[1] = 0.0f;
	myUniformData.lightDiffuse2[2] = 0.0f;
	myUniformData.lightDiffuse2[3] = 1.0f;

	myUniformData.lightSpecular2[0] = 1.0f;
	myUniformData.lightSpecular2[1] = 0.0f;
	myUniformData.lightSpecular2[2] = 0.0f;
	myUniformData.lightSpecular2[3] = 1.0f;

	myUniformData.lightPosition2[0] = 0.0f;
	myUniformData.lightPosition2[1] = 100.0f * cos(angle2);
	myUniformData.lightPosition2[2] = 100.0f * sin(angle2);
	myUniformData.lightPosition2[3] = 1.0f;

	// Light 3

	myUniformData.lightAmbient3[0] = 0.0f;
	myUniformData.lightAmbient3[1] = 0.0f;
	myUniformData.lightAmbient3[2] = 0.1f;
	myUniformData.lightAmbient3[3] = 1.0f;

	myUniformData.lightDiffuse3[0] = 0.0f;
	myUniformData.lightDiffuse3[1] = 0.0f;
	myUniformData.lightDiffuse3[2] = 1.0f;
	myUniformData.lightDiffuse3[3] = 1.0f;

	myUniformData.lightSpecular3[0] = 0.0f;
	myUniformData.lightSpecular3[1] = 0.0f;
	myUniformData.lightSpecular3[2] = 1.0f;
	myUniformData.lightSpecular3[3] = 1.0f;

	myUniformData.lightPosition3[0] = 100.0f * cos(angle3);
	myUniformData.lightPosition3[1] = 100.0f * sin(angle3);
	myUniformData.lightPosition3[2] = 0.0f;
	myUniformData.lightPosition3[3] = 1.0f;
	...
	myUniformData.lKeyIsPressed = bLight ? 1 : 0;
