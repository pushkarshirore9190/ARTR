...
VkResult createIndexBuffer(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkCreateBuffer() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkCreateBuffer() succeeded position index buffer \n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkAllocateMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkAllocateMemory() succeeded for position index buffer \n");
	}

	vkresult = vkBindBufferMemory(vkDevice, vertexData_Index.vkBuffer, vertexData_Index.vkDeviceMemory, 0);
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkBindBufferMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkBindBufferMemory() succeeded for position index buffer\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkMapMemory() function failed for position index buffer Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		__android_log_print(ANDROID_LOG_INFO, "PRS:", "createIndexBuffer() : vkMapMemory() succeeded for position index buffer\n");
	}
