...
VkResult createVulkanDevice(void)
{
	...
	{
		vkDeviceCreateInfo.pEnabledFeatures = NULL;
		fprintf(gpFile,"geometryShader is not supported");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
...
VkResult createShaders(void)
{
	...
	if (fp == NULL)
	{
		fprintf(gpFile, "createShaders() : createShader failed to open geometryshader.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to open geometryshader.spv file\n");
	}
	...
	if (size == 0)
	{
		fprintf(gpFile, "createShaders() : createShader failed and give file size of geometryshader 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if (retVal != 1)
	{
		fprintf(gpFile, "createShaders() : createShader failed to read geometryshader.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to read geometryshader.spv file\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() function failed. for geometryshader Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() succeeded for geometryshader.\n");
	}
	...
	fprintf(gpFile, "geometry Module sucessfully created\n");
