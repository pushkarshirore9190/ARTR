...
VkResult createVulkanDevice(void)
{
	...
	else
	{
		...
		fprintf(gpFile,"tessellationShader is not supported");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
...
VkResult updateUniformbuffer(void)
{
	...
	// display changing number of line segments in window titile bar
	TCHAR str[255];
	
	wsprintf(str, TEXT("PRSWindow [numberOfLineSegment = %d]"), uiNumberOfLinesSegment);
...
VkResult createShaders(void)
{
	...
	if (fp == NULL)
	{
		fprintf(gpFile, "createShaders() : createShader failed to open tessellation control.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to open tessellation control.spv file\n");
	}
	...
	if (size == 0)
	{
		fprintf(gpFile, "createShaders() : createShader failed and give file size of tessellation control shader 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if (retVal != 1)
	{
		fprintf(gpFile, "createShaders() : createShader failed to read tessellation control.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to read tessellation control.spv file\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() function failed. for tessellation control shader Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() succeeded for tessellation control shader.\n");
	}
	...
	fprintf(gpFile, "fragment Module tessellation control created\n");
	...
	if (fp == NULL)
	{
		fprintf(gpFile, "createShaders() : createShader failed to open tessellation Evaluation.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to open tessellation Evaluation.spv file\n");
	}
	...
	if (size == 0)
	{
		fprintf(gpFile, "createShaders() : createShader failed and give file size of tessellation Evaluation shader 0\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	...
	if (retVal != 1)
	{
		fprintf(gpFile, "createShaders() : createShader failed to read tessellation Evaluation.spv file\n");
		vkresult = VK_ERROR_INITIALIZATION_FAILED;
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : createShader succeeded to read tessellation Evaluation.spv file\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() function failed. for tessellation Evaluation shader Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createShaders() : vkCreateShaderModule() succeeded for tessellation Evaluation shader.\n");
	}
	...
	fprintf(gpFile, "fragment Module tessellation Evaluation created\n");
