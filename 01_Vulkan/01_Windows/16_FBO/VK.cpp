...
VkResult createImagesAndImageViews(void)
{
	...
	vkImageCreateInfo.extent.width = winWidth;  // Image width // swachain2dextent.width for linux and macos
	vkImageCreateInfo.extent.height = winHeight; // Image height // swachain2dextent.height for linux and macos
