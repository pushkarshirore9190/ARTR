...
{
	// code
	angle_1 = angle_1 + 0.5f;
	if (angle_1 >= 360.0f)
	{
		angle_1 = angle_1 - 360.0f;
	}

	angle_2 = angle_2 + 0.5f;
	if (angle_2 >= 360.0f)
	{
...
VkResult updateUniformbuffer(void)
{
	...
	glm::mat4 rotationMatrix_X = glm::rotate(glm::mat4(1.0f), glm::radians(angle_1), glm::vec3(1.0f, 0.0f, 0.0f)); // x axis rotation
