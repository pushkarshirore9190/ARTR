...
VkResult initialise(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "initialise() : createPipline() function failed for triangle(%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		fprintf(gpFile, "initialise() : createPipline() succeeded  for triangle\n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "initialise() : createPipline() function failed  for rectangle (%d)\n", vkresult);
		return(vkresult);
	}
	else
	{
		fprintf(gpFile, "initialise() : createPipline() succeeded for rectangle\n");
	}
...
VkResult resize(int width, int heigth)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "resize() : createPipline() function failed for triangle(%d)\n", vkresult);
		return(vkresult);
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "resize() : createPipline() function failed  for rectangle (%d)\n", vkresult);
		return(vkresult);
	}
