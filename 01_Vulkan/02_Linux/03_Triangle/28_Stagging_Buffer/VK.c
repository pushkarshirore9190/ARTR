...
VkResult createVertexBuffer(void)
{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() : vkAllocateCommandBuffers() function failed to make crreateCommandBuffer for ""BufferCopy"" Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() : vkAllocateCommandBuffers() succeeded to crreateCommandBuffer for ""BufferCopy"" \n");
	}
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() : vkBeginCommandBuffer() function failed Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() : vkCmdCopyBuffer() function failed Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() : vkCmdCopyBuffer() succeeded \n");
	}

	vkresult = vkEndCommandBuffer(vkCommandBuffer);
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() : vkEndCommandBuffer() function failed Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() : vkQueueSubmit() function failed Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
	...
	if (vkresult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() : vkQueueWaitIdle() function failed Error Code: (%d)\n", vkresult);
		return vkresult;
	}
	else
	{
	...
	if (vertexData_StaggingBuffer_Position.vkBuffer != VK_NULL_HANDLE) {
		...
		fprintf(gpFile, "Local staging buffer vertexData_StaggingBuffer_Position.vkBuffer destroyed\n");
	}
	...
	if (vertexData_StaggingBuffer_Position.vkDeviceMemory != VK_NULL_HANDLE) {
		...
		fprintf(gpFile, "Local staging buffer vertexData_StaggingBuffer_Position.vkDeviceMemory freed\n");
	}
